...
class RewardsAndDealsTileView: UIView {
...
extension RewardsAndDealsTileView {
    private func style() {
        ...
        headerLabel.text = "Rewards & Deals"
        ...
        bodyHeaderLabel.text = "Rewards & Deals"
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setTitle("Rewards & Deals", for: .normal)
